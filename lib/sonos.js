 ...
 * @returns {Number}
 */
Sonos.prototype.getSubGain = async function () {
  debug('Sonos.getSubGain()')
  return this.renderingControlService().GetSubGain()
}
...
/**
 * Set sub gain
 * @param {Number} gain The gain to set (-15 to 15)
 */
Sonos.prototype.setSubGain = async function (gain) {
  debug('Sonos.subGain(%j)', gain)
  return this.renderingControlService().SetSubGain(gain)
}
